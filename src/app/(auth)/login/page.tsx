  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative flex py-2 items-center">
        ...
        <span className="flex-shrink mx-4 text-xs text-text-secondary uppercase font-semibold">
          Atau
        </span>
        <div className="flex-grow border-t border-border"></div>
      </div>
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full border-accent-gold text-accent-gold hover:bg-accent-gold-light"
